...
const i18nData = {
    ja: {
        ...
        ayane: "彩音さんのホームページ！\nあたまよさそう（こなみかん）",
        wanko: "前からぼちぼち関わってるお兄さんです。\nアンテナ何故かアンテナ作ってたイメージが強い..",
    ...
    en: {
        ...
        link_title: "Links",
        slink_explain: "This is a list of our reciprocal links. If you would like to exchange links, please contact me on X.",
        my_banner: " My banner",
        image_url: "Image URL",
        title_blank: "Open",
    ...
    "zh-CN": {
        ...
        contact_text: "在这里联系我。",
        link_title: "友情链接",
        slink_explain: "本站友情链接列表。如需交换链接，请通过 X（原 Twitter）与我联系。",
        my_banner: "我的 Banner",
        image_url: "图片URL",
        title_blank: "招募中",
...
if (elements.trigger) elements.trigger.onclick = toggleMenu;
if (elements.close) elements.close.onclick = toggleMenu;
if (elements.overlay) elements.overlay.onclick = toggleMenu;
...
const updateIndicator = () => {
    if (!elements.navLinks || !elements.indicator) return;
